...
12. **卖点分层**: 按博主档案 `audience_alignment_with_brief` 主打 primary_selling_points(口播深度)+ secondary_selling_points(画面/字幕浅触达),不强行覆盖 out_of_scope 卖点
13. **职业场景反 NDA**(Catherine 等工位类博主): 不拍工位屏幕具体内容/公司名/客户名/真实业务术语/同事容貌
...
- [ ] **(Catherine 等工位类博主)画面不含工位屏幕具体内容/公司名/客户名/真实业务术语**(NDA 强约束)
- [ ] **卖点分层**: 主打博主对齐度高的卖点,不强行塞 out_of_scope 卖点
- [ ] 标题 ≤20 字,符合小红书风格
